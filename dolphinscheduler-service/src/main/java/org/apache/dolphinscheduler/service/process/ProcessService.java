...
//        List<TaskInstance> taskInstanceList = findValidTaskListByProcessId(processInstanceId);
     ...
     * 查询实例数量
     */
    public List<ProcessInstance> queryByProcessDefineCodeAndStatusDiscard(Long processDefinitionCode, int[] states) {
        return processInstanceMapper.queryByProcessDefineCodeAndStatusDiscard(processDefinitionCode, states);
    }
     ...
     * 删除实例以及相关的
     */
    public boolean deleteProcessInstanceByIdNew(long projectCode, Integer processInstanceId) {
        ProcessInstance processInstance = findProcessInstanceDetailById(processInstanceId);
        ...
        try {
            removeTaskLogFile(processInstanceId);
        } catch (Exception ignore) {
            // ignore
        }

        // delete database cascade
        int delete = deleteWorkProcessInstanceById(processInstanceId);

        deleteAllSubWorkProcessByParentId(processInstanceId);
        deleteWorkProcessMapByParentId(processInstanceId);
        deleteWorkTaskInstanceByProcessInstanceId(processInstanceId);
