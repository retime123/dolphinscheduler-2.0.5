...
export default {
  ...
  'Non Query': 'Non Query',
  //
  'Discard old instances': 'Discard old instances',
  'Keep maximum number': 'Keep maximum number',
  'Keep the number of days': 'Keep the number of days',
  'all instances': 'all instances',
  'keep failure': 'keep failure',
  'value cannot less than 1': 'value cannot less than 1',
  //
