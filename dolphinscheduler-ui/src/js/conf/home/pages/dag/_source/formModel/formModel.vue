  ...
  <div class="form-model-wrapper" v-clickoutside="_handleClose">
    ...
    <div class="content-box" v-if="isContentBox">
      <div class="form-model">
        ...
        <!-- discard-instances in workflow -->
        <m-discard-instances
          @on-discard-params="_onDiscardParams"
          ref="discardInstances"
          :backfill-item="backfillItem"
        />
...
<script>
  ...
  import mDiscardInstances from './tasks/discard_instances'
  ...
  export default {
    ...
    methods: {
      ...
      _onDiscardParams (o) {
        this.discardParams = Object.assign({}, o)
      },
      ...
      _verification () {
        ...
        // Verify discardInstances parameters
        if (!this.$refs.discardInstances.verification()) {
          return
        }
        // set preTask
      ...
      backfill (backfillItem) {
        ...
        if (!_.isEmpty(o)) {
          ...
          this.discardParams = o.discardParams || {}
